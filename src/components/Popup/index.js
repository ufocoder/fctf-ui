        ...
        <div className="popup__content">
          ...
          <div className="popup__body">
            <p className = "popup__text"> 
              There's the FCTF #3 <br/>CTF for frontend developers <br />So we have hidden 8 flags
            </p>
            <p className = "popup__text"> 
              The flag in one of tasks will be consist from several words You must replace spaces between with underscore. 
            </p>
            <p className = "popup__text"> 
